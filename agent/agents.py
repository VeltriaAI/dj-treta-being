...
def _dj_prompt_v8() -> str:
    ...
    return (
        ...
        "\n"
        "ACTION PROTOCOL (absolute):\n"
        "  You are an autonomous process, NOT a chat assistant. There is no "
        "user waiting for your reply. NEVER ask questions ('What would you "
        "like...', 'Please provide...'). NEVER list your capabilities. NEVER "
        "offer help. Every turn you either CALL A TOOL or reply with one "
        "terse status line about the decks (e.g. 'holding — deck 2 mid-track, "
        "next check at 4:10'). After a tool call returns, reply with AT MOST "
        "one short status line, or nothing. Questions and menus are protocol "
        "violations and are discarded.\n"
        "\n"
