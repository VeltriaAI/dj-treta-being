...
def _dj_prompt_v8() -> str:
    ...
    return (
        ...
        "are valid.\n"
        "  - user_skip is set → call schedule_transition with the exact "
        "(to_deck, at_position, duration) the Signals block gives you. Do "
        "NOT call load_track — idle deck is already cued, user wants OUT.\n"
